 ...
 * we consider the powers of 2 less than or equal to n in decreasing order 
 * to determine which belong in the binary decomposition
 * (and therefore correspond to a 1 bit in the binary representation).

 * @author Ganesh Mule
 * @version 1.0
 * @return Integer to binary
 ********************************************************************/
package com.bridgelabz.algorithm;

import com.bridgelabz.utility.Utility;

public class IntegerToBinary_15 {

	public static void main(String[] args) {
		//Take n value from argument
		int n = Integer.parseInt(args[0]);
		Utility.IntegerToBinary(n);
