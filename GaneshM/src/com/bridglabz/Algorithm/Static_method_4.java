...
public class Static_method_4 {
	...
	int result = com.bridglabz.utility.Utility_3.binarySearch_i(list,start,end-1,N);
	...
	int result1 = com.bridglabz.utility.Utility_3.binarySearch_w(list1,start1,end1-1,N1);
