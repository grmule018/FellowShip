...
public class Commercial {
	...
	public static void main(String[] args) throws JsonParseException, JsonMappingException, IOException
	{
		...
		File personFile=new File("/home/user/Downloads/RELEASE/GaneshM/src/com/grm/oops/SPerson.json");
		File companyFile=new File("/home/user/Downloads/RELEASE/GaneshM/src/com/grm/oops/Company.json");
