...
import com.bridglabz.datastructures1.Node;
...
public class NodeUtility
{
	...
	public Node readFile(Node start)
	{
		try
		{
			FileInputStream fis = new FileInputStream("/home/user/Downloads/RELEASE/GaneshM/src/com/bridglabz/datastructures1/integer.txt");
			char ch;
			String word3="";
  	...
  	public void writeFile(Node tNode)
	{
		...
		{
			String tString="";
		    File file=new File("/home/user/Downloads/RELEASE/GaneshM/src/com/bridglabz/datastructures1/NewText.txt");
		    file.createNewFile();
