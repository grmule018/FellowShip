...
public class Static_method_4 {
	...
	int result = com.grm.utility.Utility_3.binarySearch_i(list,start,end-1,N);
	...
	int result1 = com.grm.utility.Utility_3.binarySearch_w(list1,start1,end1-1,N1);
	...
	com.grm.utility.Utility_3.insertion_i(list_i,N_i);
	...
	com.grm.utility.Utility_3.insertion(list_i_w,N_i_w);
	...
	com.grm.utility.Utility_3.bubble_i(list_b_i,N_b_i);
	...
	com.grm.utility.Utility_3.bubble_w(list_b_w,N_b_w);
